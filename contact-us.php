...
.btn_getQuote:after {
 ...
 .btn_getQuote {
    ...
    <main id="body-content" style="margin-top : 100px">
        ...
        <section class="wide-tb-60 contact-full-shadow">
            <div class="container">

                <div class="row justify-content-between">
                    <div class="col-md-5 col-sm-12 col-lg-4 wow fadeInRight" data-wow-duration="0" data-wow-delay="0s">
                        <div class="contact-detail-shadow">
                            <h4><b>Head Office & Study Centre:</b></h4><br>
                            <div class="d-flex align-items-start items">
                                <i class="icofont-google-map"></i> <span>L-3, Kanchanjunga Building Barakhamba Road,
                                    Connaught Place <br> New Delhi - 110001</span>
                            </div>
                            <div class="d-flex align-items-start items">
                                <i class="icofont-phone"></i> <a href="#" style="color: #212529!important;">+91-
                                    98100 33495 <br> 011-45 019 365</a>
                            </div>

                            <div class="text-nowrap d-flex align-items-start items" style="margin-bottom: 0px !important;">
                                <i class="icofont-email"></i> <a href="#" style="color: #0d3d6b !important;">info@templeoflearning.in</a><br>

                            </div>

                        </div>
                    </div>
                    <div class="col-md-7 col-sm-12 col-lg-8 wow fadeInLeft" data-wow-duration="0" data-wow-delay="0s">
                        <div class="free-quote-form contact-page bod-r" style="padding:30px 15px;">
                            <!-- Heading Main -->
                            <h3 class="heading-main mb-4" style="color: #0d3d6b !important;">
                                Request A Call Back
                            </h3>
                            <!-- Heading Main -->

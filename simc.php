...
<head>
  ...
  <title>Symbiosis Institute of Media & Communication</title>
          ...
          <div class="container">
            <div class="row">
              <div class="col col-xs-12 about-company-s2-slider-wrapper">
                <h2 class="mb-4 fw-7" style="margin-bottom: 43px !important;">
                  Course: B.A (MC)<span class="fw-3 txt-orange"></span>
                </h2>
                <p class="p-justify"><b>Intake:</b> 120 seats</p>
                <p class="p-justify"><b>Admission Process and Eligibility: (as per 2017 Notification)</b> </p>

                <ol>
                  <li>
                    <p class="p-justify">XII pass from any branch with minimum 50% marks for general category and 45% for students of SC and ST category.</p>
                  </li>
                  <li>
                    <p class="p-justify">Qualifying the <b>Symbiosis Entrance Test (SET) on 6th May 2017 +</b> Personal interview & Writing Ability Test + Studio Test.</p>
                  </li>
                </ol>
                <p class="p-justify"><b>SCMC : 30 Marks (SET) + 30 Marks (PI) + 10 Marks (WAT)+10 Marks (Studio Test) + 20(Academic Profile)</b></p>
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              ...
              <p class="p-justify"><b>Each question carries One mark and NO negative marking</b></p>
            </div>
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              ...
              <h5 style="text-align: center;font-weight: 600;">CURRICULUM</h5>
              <table class="table table-striped">
                <thead>
                  <tr style="    background-color: #0d3d6b;color: #fff;font-size: 17px;">

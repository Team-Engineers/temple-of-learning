...
<head>
  ...
  <title>About Temple of learning Test Prep - India NCRs #1 Entrance Prep Institute for DU BMS 2022, CLAT 2022</title>
  <meta name="author" content="">
  <meta name="description" content="Join Temple of learning for 1 Year, 2 Year, Crash Course Preparation for DU BMS, CLAT, IIM Indore IPM Entrances 2022">
  <meta name="title" content="About Temple of learning Test Prep - India NCRs #1 Entrance Prep Institute for DU BMS 2022, CLAT 2022">
...
<body>
  ...
  <!-- <div class="row" id="mobile_top" style="display: none; background: #103f6b !important; width: 100% !important;">
    ...
    <div class="col-6" style="">
        <a href="http://psis.Temple of learningedu.com/" role="button" style="">
            <button
  ...
  <main id="body-content">
    ...
    <section class="wide-tb-60" style="background-color: #fafafa;">
      <div class="container pos-rel">
        <div class="row align-items-center" style="margin-top: 100px;">
          ...
          <div class="col-md-12 wow fadeInLeft" data-wow-duration="0" data-wow-delay="0s" style="background-image: url();">

            <p class="p-sty">Temple of Learning is an educational institution that remains committed to emerging as one of the leading institutes, thereby transforming the budding youth into successful individuals. Temple of Learning means ‘the first one’: just as the name suggests, we leave no stone unturned in catering to the aspirations of several students. The flourishing organization has been adept in providing aid to more than 80,000 students, thriving to pave their careers remarkably in the race for success. At Temple of Learning, we attempt to enhance the overall personalities of individuals who splurge both with intelligence and prowess.
              .</p>

            <p class="p-sty">At Temple of Learning, we attempt to enhance the overall personalities of individuals who splurge both with intelligence and prowess.
              This leading organization is the epitome of hard work, blended with aspiration and perseverance. Its optimistic approach helps many achieve their career goals by brushing their strengths. Just as our ethos suggests, Temple of learning ‘Leads the Way’, urging dynamic individuals to overcome their weaknesses and pitfalls. It adheres to delivering a peripheral direction where success is the epicentre of everything. </p>

            <p class="p-sty">Throughout the years of rapid evolution, the institute altogether has been embracing brilliance, knowledge and education that help students foster and discover their aptitude. Temple of learning directs students to cling on to these stimulating aptitudes, so that they can compete, excel and ace in a number of entrance examinations, framing a bright picture of their future.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="wide-tb-60">
      <div class="container">
        <div class="row">
          <div class="col-lg-9 col-md-9 col-sm-12 wow fadeInRight" data-wow-duration="0" data-wow-delay="0s">
            <h5 class="h3-sm fw-6 txt-blue mb-5" style="font-size: 19px;color: #0d3d6b;">Temple of learning Test Prep is a place that prepares and trains students for various General Aptitude based examinations for:-</h5>
            <div class="col-lg-12 col-md-12 col-sm-12" style="float: left;">

              <ul class="list-unstyled icons-listing theme-dark mb-0">
                <li><i class="icofont-dotted-right" style="color: #f9b618;"></i>Management</li>
                <li><i class="icofont-dotted-right" style="color: #f9b618;"></i>Mass Communication</li>
                <li><i class="icofont-dotted-right" style="color: #f9b618;"></i>Bachelor in Computer Application</li>
                <li><i class="icofont-dotted-right" style="color: #f9b618;"></i>Law</li>
                <li><i class="icofont-dotted-right" style="color: #f9b618;"></i>Hotel Management</li>
                <li><i class="icofont-dotted-right" style="color: #f9b618;"></i>Scholastic Aptitude Test (SAT )</li>
              </ul>
                ...
                <div class="d-lg-flex justify-content-end no-gutters mb-spacer-md" style="box-shadow: 0px 18px 76px 0px rgba(0, 0, 0, 0.06);">
                  ...
                  <div class="col-md-5 col-12">
                    <div class="px-3 m-5  w-full m-3-i">
                      ...
                      <form action="#" method="post" id="requestmodal_form" class="rounded-field">
                        ...
                        <div class="form-row m-bottom">
                          ...
                          <div class="col col-lg-12">
                            <select title="Please choose a package" required="" id="program_model" class="custom-select" aria-required="true" aria-invalid="false">
                              ...
                              <option value="International Education">International Education
                              </option>
                            </select>
                          </div>
                        </div>
                        <div class="form-row m-bottom">
                          <div class="col">
                            <select title="Please choose a package" required="" id="course_type_model" class="custom-select" aria-required="true" aria-invalid="false">
                        ...
                        <div class="form-row m-bottom">
                          <div class="col">
                            <input type="text" id="firstname_model" class="form-control" placeholder="First Name">
                          </div>
                          <div class="col">
                            <input type="text" id="lastname_model" class="form-control" placeholder="Last Name">
                          </div>
                        </div>
                        <div class="form-row m-bottom">
                          <div class="col">
                            <input type="text" id="s_phone_model" class="form-control" placeholder="Phone">
                          </div>
                          <div class="col">
                            <input type="email" id="s_email_model" class="form-control" placeholder="Email">
                          </div>
                        </div>
                        <div class="form-row m-bottom">
                          <div class="col">

                            <select name="s_city_model" id="s_city_model" class="form-control" placeholder="State">
                          ...
                          <div class="col">
                            <input type="text" id="s_school_model" class="form-control" placeholder="School">
                          </div>
                        </div>
                        <div class="form-row m-bottom">
                          <div class="col">
                            <select title="Please choose a package" required="" id="s_class_model" class="custom-select" aria-required="true" aria-invalid="false">
                        ...
                        <div class="form-row">
                          <div class="col pt-3">
                            <button type="button" id="request_model_btn" class="form-btn btn-theme bg-orange">Submit <i class="icofont-rounded-right"></i></button>
                          </div>
                        </div>
                      </form>
                    </div>

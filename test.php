  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <article class="question single-question question-type-normal" style="margin-top: 100px;">
        ...
        <h2>
            ...
            <div class="question-main">Which one of the following numbers can be removed from the set S = {0, 2, 4, 5, 9} without changing the average of set S?</div>
        </h2>
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">Average cost of 5 apples and 4 mangoes is Rs. 36. The average cost of 7 apples and 8 mangoes is Rs. 48. Find the total cost of 24 apples and 24 mangoes.</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">The average weight of three boys A, B and C is $$\frac{{163}}{3}$$ kg, while the average weight of three boys B, D and E is 53 kg. What is the average weight of A, B, C, D and E?</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">Average of ten positive numbers is x. If each number is increased by 10%, then x :</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">The average price of 10 books is Rs.12 while the average price of 8 of these books is Rs. 11.75. Of the remaining two books, if the price of one book is 60% more than the price of the other, what is the price of each of these two books?</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">Nine persons went to a hotel for taking their meals. Eight of them spent Rs.12 each on their meals and the ninth spent Rs.8 more than the average expenditure of all the nine. What was the total money spent by them.</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">The average of runs of a cricket player of 10 innings was 32. How many runes must be made in his next innings so as to increase his average of runs by 4?</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">The average score of a cricketer for ten matches is 38.9 runs. If the average for the first six matches is 42, then find the average for the last four matches.</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">Distance between two stations A and B is 778km. A train covers the journey from A to B at 84km per hour and returns back to A with a uniform speed of 56km per hour. Find the average speed of train during the whole journey.</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <article class="question single-question question-type-normal">
        ...
        <h2>
            ...
            <div class="question-main">The average of 50 numbers is 30. If two numbers, 35 and 40 are discarded, then the average of the remaining numbers is nearly:</div>
        </h2>
        <div class="question-inner">
            <div class="form-style form-style-3">
                <div class="form-inputs clearfix question-options">
    ...
    <script type="text/x-mathjax-config">MathJax.Hub.Config({  displayAlign: "inherit",  displayIndent: "1.5em"});MathJax.Hub.Config({ "HTML-CSS": { linebreaks: { automatic: true }, styles: {".MathJax_Display": { "font-style": "normal","font-size":  "90%","display": "inline"}} }});
		</script>
</body>

                ...
                <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <p class="justify"> Content to be uploaded Soon</p>
                                            ...
                                            <form action="userdata.php" method="post" id="requestmodal_form" class="rounded-field">
                                                ...
                                                <div class="form-row m-bottom">
                                                    ...
                                                    <div class="col col-lg-12">
                                                        <select title="Please choose a package" required="" id="program_model" class="custom-select" aria-required="true" aria-invalid="false" name="program">
                                                            ...
                                                            <option value="Hybrid Program">Crash Course</option>
                                                            <option value="Non Classroom Program">NTSE</option>
                                                            <option value="International Education">Career Guidance
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-row m-bottom">
                                                    <div class="col">
                                                        <select title="Please choose a package" required="" id="course_type_model" class="custom-select" aria-required="true" aria-invalid="false" name="course">
                                                            ...
                                                            <option value="SAT- Intl Edu ">Class 9th </option>
                                                            <option value="Financial Courses">Class 10th</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-row m-bottom">
                                                    <div class="col">
                                                        <input type="text" id="firstname_model" class="form-control" placeholder="First Name" name="first-name">
                                                    </div>
                                                    <div class="col">
                                                        <input type="text" id="lastname_model" class="form-control" placeholder="Last Name" name="last-name">
                                                    </div>
                                                </div>
                                                <div class="form-row m-bottom">
                                                    <div class="col">
                                                        <input type="text" id="s_phone_model" class="form-control" placeholder="Phone" name="number">
                                                    </div>
                                                    <div class="col">
                                                        <input type="email" id="s_email_model" class="form-control" placeholder="Email" name="email">
                                                    </div>
                                                </div>
                                                <div class="form-row m-bottom">
                                                    <div class="col">

                                                        <select name="s_city_model" id="s_city_model" class="form-control" placeholder="State" name="city">
                                                ...
                                                <div class="form-row m-bottom">
                                                    <div class="col">
                                                        <select title="Please choose a package" required="" id="s_class_model" class="custom-select" aria-required="true" aria-invalid="false" name="curr-class">
